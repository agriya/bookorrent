...
$content_dashboard = __l('To see overall site activities and to notify the actions that admin need to taken');
$content_affiliates = __l('To see overall site activities and to notify the actions that admin need to taken');
...
CmsNav::add('dashboard', array(
    ...
    'data-bootstro-content' => $content_dashboard,
    'icon-class' => 'home',
...
CmsNav::add('users', array(
    ...
    'data-bootstro-content' => __l('To manage the site user list, to send bulk email to site users'),
    'icon-class' => 'user',
    'weight' => 20,
    'children' => array(
        'users' => array(
...
foreach($settingCategories as $settingCategory) {
    ...
    $tmp_settings[$settingCategory['SettingCategory']['name']] = array(
        'title' => __l($settingCategory['SettingCategory']['name']),
        'url' => array(
            'admin' => true,
            'controller' => 'settings',
            'action' => 'edit',
...
CmsNav::add('payments', array(
    ...
    'data-bootstro-content' => $content_affiliates,
...
CmsNav::add('cms', array(
    ...
    'data-bootstro-content' => __l('To customize and manage the listing form and their pricing type, also manage the site themes, contents, menu etc.') ,
    'url' => array(
        'admin' => true,
        'controller' => 'pages',
        'action' => 'index',
...
CmsNav::add('masters', array(
    ...
    'data-bootstro-content' => __l('To manage all the master. Master includes cities, countries, states, email template etc.') ,
    'is_hide_title' => 1,
    'column' => 2,
    'column_1' => 9,
    'url' => array(
