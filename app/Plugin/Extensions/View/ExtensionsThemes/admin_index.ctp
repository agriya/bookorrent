<div class="space">
    ...
    <?php
      ...
      echo __l($currentTheme['name']) . ' ' . __l('by') . ' ' . $author;
    ?>
    </h5>
    </div>
    <div><?php echo __l($currentTheme['description']); ?></div>
   ...
   <div class="thumbnail">
    ...
    <?php
            ...
            echo $this->Html->tag('div', $this->Html->link(__l('Activate'), array('action' => 'activate', $themeAlias), array('class' => 'js-confirm', 'title' => __l('Activate'))) . $this->Html->link(__l('Delete'), array('action' => 'delete', $themeAlias), array('class' => 'js-confirm', 'title' => __l('Delete'))));
          echo '</li>';
        }
      }
      if (empty($is_themes_available)) {
        echo '<li><div class="space dc"><p class="ver-mspace grayc top-space text-16 ">' . __l('No Themes available') . '</p></div></li>';
      }
    ?>
    </ol>
    </div>
