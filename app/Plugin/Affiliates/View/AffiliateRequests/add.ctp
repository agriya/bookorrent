...
?>
	 <div class="info-message info-message2 info-message1 "><?php echo __l('Sorry, admin declined your request. If you want submit once again please'). $this->Html->link(__l('Click here'), array('controller' => 'affiliates', 'action' => 'index', 'status' =>'add'), array('class' => '', 'title' => __l('Click here'))); ?> </div>
<?php 
