...
<ul class="breadcrumb top-mspace ver-space">
              ...
              <li class="active"><?php echo __l('Affiliate Requests'); ?></li>
            </ul> 
...
?>
	<tr<?php echo $class;?>>
         <td class="select"><?php echo $this->Form->input('AffiliateRequest.'.$affiliateRequest['AffiliateRequest']['id'].'.id', array('type' => 'checkbox', 'id' => "admin_checkbox_".$affiliateRequest['AffiliateRequest']['id'], 'label' => "", 'class' => $status_class.' js-checkbox-list')); ?></td>
...
if (!empty($affiliateRequests)) :
       ...
       <span class="graydarkc">
            ...
            <?php echo $this->Html->link(__l('Disapprove'), '#', array('class' => 'hor-smspace grayc js-select js-no-pjax {"checked":"js-checkbox-inactive","unchecked":"js-checkbox-active"}', 'title' => __l('Disapprove'))); ?>
		    <?php echo $this->Html->link(__l('Approve'), '#', array('class' => 'hor-smspace grayc js-select js-no-pjax {"checked":"js-checkbox-active","unchecked":"js-checkbox-inactive"}', 'title' => __l('Approve'))); ?>
