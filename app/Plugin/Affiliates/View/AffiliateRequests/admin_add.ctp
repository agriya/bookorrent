...
<ul class="breadcrumb top-mspace ver-space">
  ...
  <li class="active"><?php echo __l('Add Affiliate Request'); ?></li>
</ul>
...
<?php echo $this->Form->create('AffiliateRequest', array('class' => 'form-horizontal space'));?>
	<fieldset>
		...
		echo $this->Form->input('why_do_you_want_affiliate', array('label' => __l('Why Do You Want Affiliate?')));
    ...
    <?php echo $this->Form->input('is_approved', array('legend' => false, 'type' => 'radio','div'=> array('class' => 'input radio no-mar'), 'options' => array(0 => __l('Waiting for approval'), 1 => __l('Approved'), '2' => __l('Rejected'))));
	?>
		</div>
	</fieldset>
