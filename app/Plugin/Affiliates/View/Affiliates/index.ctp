...
<div class="ver-space">
	...
	<tr class=" well no-mar no-pad">
        ...
        <th class="sep-right"><?php echo __l('User') . '/' . Configure::read('item.alt_name_for_item_singular_caps');?></th>
        ...
        <th class="dc"><?php echo $this->Paginator->sort('commission_amount',__l('Commission').'('.configure::read('site.currency').')');?></th>
    </tr>
<?php
if (!empty($affiliates)):
$i = 0;
...
?>
	<tr>
        ...
        <td>
			...
			?>
					<?php 
					if(!empty($affiliate['ItemUser'])) {
						echo $this->Html->link($this->Html->cText($affiliate['ItemUser']['Item']['title'],false), array('controller'=> 'items', 'action' => 'view', $affiliate['ItemUser']['Item']['slug']), array('escape' => false));?>
