...
class AffiliateCashWithdrawal extends AppModel
{
    ...
    {
        $transaction_id = $this->User->Transaction->log($affiliateCashWithdrawal['AffiliateCashWithdrawal']['id'], 'Affiliates.AffiliateCashWithdrawal', $affiliateCashWithdrawal['AffiliateCashWithdrawal']['payment_gateway_id'], ConstTransactionTypes::AffliateCashWithdrawalRequestApproved);
