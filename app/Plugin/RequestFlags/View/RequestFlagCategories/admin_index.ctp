...
<ul class="breadcrumb top-mspace ver-space">
              ...
              <li class="active"><?php echo __l('Request Flag Categories'); ?></li>
            </ul> 
...
?>
 <tr class="<?php echo $class.' '.$active_class;?>">
		<td class="dc"><?php echo $this->Form->input('RequestFlagCategory.'.$requestFlagCategory['RequestFlagCategory']['id'].'.id', array('type' => 'checkbox', 'id' => "admin_checkbox_".$requestFlagCategory['RequestFlagCategory']['id'], 'label' => "", 'class' => $status_class.' js-checkbox-list')); ?></td>
