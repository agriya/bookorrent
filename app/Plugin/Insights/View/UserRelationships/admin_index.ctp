...
<ul class="breadcrumb top-mspace ver-space">
              ...
              <li class="active"><?php echo __l('Relationships');?></li>
            </ul> 
...
<div class="ver-space">
	...
	<tr class=" well no-mar no-pad">
       ...
       <th class="sep-right"><?php echo $this->Paginator->sort( 'relationship',__l('Relationship'));?></th>
       </tr></thead><tbody>
<?php
...
?>
	<tr class="<?php echo $class.' '.$active_class;?>">
		<td class="dc"><?php echo $this->Form->input('UserRelationship.'.$userRelationship['UserRelationship']['id'].'.id', array('type' => 'checkbox', 'id' => "admin_checkbox_".$userRelationship['UserRelationship']['id'], 'label' => "", 'class' => $status_class.' js-checkbox-list')); ?></td>
		<td class="dc"><span class="dropdown"> <span title="<?php echo __l('Actions');?>" data-toggle="dropdown" class="graydarkc left-space hor-smspace icon-cog text-18 cur dropdown-toggle"> <span class="hide"><?php echo __l('Actions');?></span> </span>
					...
					<li><?php echo $this->Html->link('<i class="icon-edit"></i>'.__l('Edit'), array('action' => 'edit', $userRelationship['UserRelationship']['id']), array('escape' => false,'class' => 'delete', 'title' => __l('Edit')));?></li>
        			<li><?php echo $this->Html->link('<i class="icon-remove"></i>'.__l('Delete'), array('action' => 'delete', $userRelationship['UserRelationship']['id']), array('escape' => false,'class' => 'delete js-delete', 'title' => __l('Delete')));?></li>
			   </ul>
							 </span>
                            </td>
...
?>
	<tr>
		<td colspan="6">
			<div class="space dc">
				<p class="ver-mspace grayc top-space text-16 "><?php echo __l('No Relationships available');?></p>
			</div>
		</td>
	</tr>
<?php
