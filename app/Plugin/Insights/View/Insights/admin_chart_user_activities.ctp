  ...
  <div class="accordion-group">
    ...
    <div id="userActivities" class="accordion-body collapse over-hide <?php echo $collapse_class;?>">
      <div class="accordion-inner">
        ...
        <?php $chart_title = Configure::read('item.alt_name_for_item_singular_caps') . ' ' . __l('Flags');
		  $chart_y_title = Configure::read('item.alt_name_for_item_singular_caps') . ' ' . __l('Flags'); ?>
         <section class="span12 sep">
		      <div class="<?php echo $div_class;?> space dc { 'chart_width':'500', 'chart_type':'ColumnChart','data_container':'item_flags_data', 'chart_container':'item_flags_chart<?php echo $role_id; ?>', 'chart_title':'<?php echo $chart_title ;?>', 'chart_y_title': '<?php echo $chart_y_title;?>'}">
              <div class="clearfix">
                <div id="item_flags_chart<?php echo $role_id; ?>" class="admin-dashboard-chart"></div>
                <div class="hide">
                 <table id="item_flags_data" class="table table-striped table-bordered table-condensed">
					<tbody>
					  <?php foreach($item_flags_data as $key => $_data): ?>
					  <tr>
						 <th><?php echo $key; ?></th>
						 <td><?php echo $_data[0]; ?></td>
					  </tr>
		...
		<div class="row-fluid ver-space" id="itemFavorites">
		
		<?php $chart_title = Configure::read('item.alt_name_for_item_singular_caps') . ' ' . __l('Favorites');
		  $chart_y_title = Configure::read('item.alt_name_for_item_singular_caps') . ' ' . __l('Favorites'); ?>
		  <section class="span12 sep">
		      <div class="<?php echo $div_class;?> space dc { 'chart_width':'500', 'chart_type':'ColumnChart','data_container':'item_favorites_data', 'chart_container':'item_favorites_chart<?php echo $role_id; ?>', 'chart_title':'<?php echo $chart_title ;?>', 'chart_y_title': '<?php echo $chart_y_title;?>'}">
              <div class="clearfix">
                <div id="item_favorites_chart<?php echo $role_id; ?>" class="admin-dashboard-chart"></div>
                <div class="hide">
                 <table id="item_favorites_data" class="table table-striped table-bordered table-condensed">
					<tbody>
					  <?php foreach($item_favorites_data as $key => $_data): ?>
					  <tr>
						 <th><?php echo $key; ?></th>
						 <td><?php echo $_data[0]; ?></td>
					  </tr>
