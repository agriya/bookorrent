<div class="js-cache-load-admin-charts-users">
  <div class="js-user-register">
  <div class="accordion-group">
    ...
    <div id="registration" class="accordion-body collapse over-hide <?php echo $collapse_class;?>">
      <div class="accordion-inner" id="registration">
        <?php
        ...
        <?php  if (isPluginEnabled('Insights')) {?>
          <?php echo $this->element('chart-user_demographics', array('cache' => array('config' => 'site_element_cache_15_min', 'key' => $this->Auth->user('id')), 'chart_y_title' => $chart_y_title), array('plugin' => 'Insights')); ?>
        <?php }?>
      </div>
    </div>
  </div>
