...
CmsNav::add('analytics', array(
    ...
    'data-bootstro-content' => sprintf(__l('To analyze overall user registration rate, their demographics, user login rate and also the overall %s posting/booking rate.'), Configure::read('item.alt_name_for_item_singular_small')),
