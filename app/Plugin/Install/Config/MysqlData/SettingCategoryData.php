...
class SettingCategoryData {
	...
	public $records = array(
		...
		array(
			...
			'parent_id' => '0',
			'name' => 'Listing',
			'description' => 'Manage & configure settings related to listing and booking options.',
			'plugin_name' => ''
		),
		array(
			'id' => '8',
			...
			'parent_id' => '0',
			'name' => 'Revenue',
			'description' => 'Manage & configure settings related to listings, listing fee and commission options.',
			'plugin_name' => ''
		),
		array(
			'id' => '9',
		...
		array(
			...
			'description' => 'Manage Suspicious word detector feature, Auto suspend listing on system flag, Auto suspend request on system flag, Auto suspend message on system flag.',
			'plugin_name' => ''
		),
		array(
			'id' => '11',
		...
		array(
			...
			'description' => 'Here you can modify listing list related settings such as auto approve listing, maximum photo upload per listing',
			'plugin_name' => 'Items'
		),
		array(
			'id' => '33',
			...
			'description' => 'Here you can modify listing booking related settings such as maximum negotiation discount, auto expire booking',
			'plugin_name' => 'Items'
		),
		array(
			'id' => '34',
			...
			'parent_id' => '7',
			'name' => 'Configuration',
			'description' => 'Here you can modify enable and disable delayed chained payment, secuirty deposit',
			'plugin_name' => ''
		),
		array(
			'id' => '35',
		...
		array(
			...
			'description' => 'Here you can manage booking commission percentage from host and booker',
			'plugin_name' => ''
		),
		array(
			'id' => '38',
			...
			'description' => 'Here you can manage listing and user membership fee',
			'plugin_name' => ''
		),
		array(
			'id' => '39',
		...
		array(
			...
			'description' => 'Here you can enable / disable auto suspend for requests, messages and listings on system flag.',
			'plugin_name' => ''
		),
		array(
			'id' => '42',
		...
		array(
			...
			'parent_id' => '15',
			'name' => 'Twitter',
			'description' => 'Twitter is used for login and posting message using its account details. For doing above, our site must be configured with existing Twitter account. <a target=\"_blank\" href=\"http://dev1products.dev.agriya.com/doku.php?id=twitter-hybridauth-setup\"> http://dev1products.dev.agriya.com/doku.php?id=twitter-hybridauth-setup </a>',
			'plugin_name' => ''
		),
		array(
			'id' => '50',
		...
		array(
			...
			'parent_id' => '15',
			'name' => 'Google',
			'description' => 'We use this service for importing contacts from Gmail for friends invite. For doing above, our site must be configured with existing Gmail account. <a target=\"_blank\" href=\"http://dev1products.dev.agriya.com/doku.php?id=google-hybridauth-setup\"> http://dev1products.dev.agriya.com/doku.php?id=google-hybridauth-setup </a>',
			'plugin_name' => ''
		),
		array(
			'id' => '54',
		...
		array(
			...
			'description' => 'By enabling this, most of the pages will be disk-cached. This will avoid PHP and database access. Caveat of this approach is that users will be presented with little outdated contents. Since, this Agriya BookorRent script is highly optimized for this approach, this is highly recommended for good performance. ',
			'plugin_name' => 'HighPerformance'
		),
		array(
			'id' => '74',
		...
		array(
			'id' => '87',
			'created' => '2013-12-17 15:40:12',
			'modified' => '2013-12-17 15:40:12',
			'parent_id' => '7',
		...
		array(
			'id' => '88',
			'created' => '2016-01-28 17:20:00',
			'modified' => '2016-01-28 17:20:00',
			'parent_id' => '7',
			'name' => 'Seat Configuration',
			'description' => 'Seat configuration which will be used throughout the site',
			'plugin_name' => 'Seats'
		),
	);
