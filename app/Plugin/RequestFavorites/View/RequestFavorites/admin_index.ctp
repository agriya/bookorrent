...
<ul class="breadcrumb top-mspace ver-space">
              ...
              <li class="active"><?php echo __l('Request Favorites'); ?></li>
            </ul> 
<?php endif; ?>			
...
?>
	<tr<?php echo $class;?>>
	<?php if(empty($this->request->params['named']['simple_view'])) : ?>
		<td class="select dc"><?php echo $this->Form->input('RequestFavorite.'.$requestFavorite['RequestFavorite']['id'].'.id', array('type' => 'checkbox', 'id' => "admin_checkbox_".$requestFavorite['RequestFavorite']['id'], 'label' => "", 'class' => 'js-checkbox-list')); ?></td>
		<?php endif; ?>
		        ...
		        <?php
                 if(!empty($requestFavorite['Ip']['ip'])): ?>
                            ...
                            if(!empty($requestFavorite['Ip']['Country'])):
                                ?>
                                <span class="flags flag-<?php echo $this->Html->cText(strtolower($requestFavorite['Ip']['Country']['iso_alpha2']), false); ?>" title ="<?php echo $this->Html->cText($requestFavorite['Ip']['Country']['name'], false); ?>">
