...
<ul class="breadcrumb top-mspace ver-space">
              <li><?php echo $this->Html->link(__l('Translations'), array('action'=>'index'), array('escape' => false));?> <span class="divider">/</span></li>
...
<?php echo $this->Form->create('Translation', array('class' => 'form-horizontal space'));?>
	<fieldset>
	<?php
		echo $this->Form->input('from_language', array('value' => __l('English'), 'disabled' => true,'label' => __l('From Language')));
		...
		<div class="clearfix translation-index-block">
			<div class="translation-left-block  ">
				<div class="clearfix">
        		<?php
        		echo $this->Form->submit(__l('Manual Translate'), array('name' => 'data[Translation][manualTranslate]','class'=>'btn btn-large hor-mspace btn-primary textb text-16'));
        		?>
				</div>
            ...
            <div class="translation-right-block  ">
				<div class="clearfix">
                <?php echo $this->Form->submit(__l('Google Translate'), array('name' => 'data[Translation][googleTranslate]', 'disabled' => $disabled,'class'=>'btn btn-large hor-mspace btn-primary textb text-16'));	?>
				</div>
