...
<ul class="breadcrumb top-mspace ver-space">
              <li><?php echo $this->Html->link(__l('Translation'), array('action'=>'index'), array('escape' => false));?> <span class="divider">/</span></li>
              <li class="active"><?php echo __l('Edit Translations');?> </li>
            </ul> 
...
<?php echo $this->Form->create('Translation', array('action' => 'manage', 'class' => 'form-horizontal space')); ?>
	...
	<?php
		echo "<span class='hor-space'>".$this->Form->input('language_id',array('div'=>false,'label' => __l('Language')))."</span>";
		echo $this->Form->input('filter', array('type' => 'hidden'));
		echo "<span class='hor-space'>".$this->Form->input('q', array('label' => false, 'placeholder' => __l('Keyword'), 'div'=>false, 'maxlength' => '255'))."</span>";
		?>
		<?php
  ...
  <tr class="well no-mar no-pad">
    ...
    <?php
		if(!empty($translations)):
            ...
            <td class="dc messages-key"><?php echo $this->Html->cText($translation['Translation']['name'], false); ?></td>
             <td class="dc "> <?php echo $this->Form->input('Translation.'.$translation['Translation']['id'].'.lang_text', array('label' => false, 'class' => 'messages-value', 'value' => $translation['Translation']['lang_text'])); ?></td>
            </tr>
		<?php	
            endforeach;
			?>
