		...
		<div id="list" class="tab-pane active in no-mar">
			...
			<fieldset>
				...
				<?php foreach ($languages as $lang_id => $lang_name) : ?>
					<h3 class="well space textb text-16 no-mar"><?php echo $this->Html->cText($lang_name, false);?></h3>
					<?php echo $this->Form->input('Translation.'.$lang_id.'.lang_text', array('label' => __l('Lang Text'))); ?>
				<?php endforeach; ?>
			</fieldset>
