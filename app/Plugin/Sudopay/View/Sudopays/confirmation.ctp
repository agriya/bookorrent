...
<div class="thumbnail clearfix space">
	...
	<?php
		echo $this->Form->create('Sudopay', array('url' => array('controller' => 'sudopays', 'action'=> 'confirmation', $foreign_id,$transaction_type), 'class' => 'form-horizontal js-item-form clearfix','enctype' => 'multipart/form-data'));
	?>
	<div class = "space">
	<?php
