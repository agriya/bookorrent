...
?>
	<div class="span hor-space pull-left clearfix well">
        <div class="clearfix top-space">
            ...
            <span class="js-bootstrap-tooltip space" title="<?php echo __l('This will fetch latest configurations (subscription plan & gateways) from zazpaypay.com.'); ?>"><i class="icon-question-sign"></i></span>
        </div>
		...
		<dd>
			<div class="span5 pull-left">
				<div id="setting-sudopay_website_id" class="input text">
                    ...
                    ?>
					<?php echo $branding; ?>&nbsp;<i class="icon-info-sign js-bootstrap-tooltip" title = "<?php echo $this->Html->cText($subscriptionInfo[$gateway_settings['is_payment_via_api']], false); ?>"></i>
				</div>
			</div>
		</dd>
