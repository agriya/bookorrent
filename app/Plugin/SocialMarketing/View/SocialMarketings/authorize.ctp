<div id="<?php echo $this->Html->cText($authorize_name, false);?>-authorizecontainer" class="container top-space">
...
<meta http-equiv="refresh"  content="5;url=<?php echo $this->Html->cText($redirect_url, false); ?>" />
