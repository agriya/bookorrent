      ...
      <?php if ($this->request->params['named']['type'] == 'facebook') { ?>
        <div id="facebook" class="loader fade in active" data-fb_app_id="<?php echo Configure::read('facebook.app_id') ?>">
          ...
          ?>
              ...
              <div class="span16">
                <iframe src="<?php echo $this->Html->cText($feed_url, false); ?>" height="500" width="500"  frameborder="0" scrolling="no"></iframe>
              </div>
              <div class="span5">
        ...
        <div id="twitter">
          <?php if (!empty($user['User']['is_twitter_connected'])) { ?>
			...
			<div class="span16 space">&nbsp;
				<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo Router::url('/', true); ?>" data-text="<?php echo $this->Html->cText($default_content, false);?>" data-size="large">Tweet</a>
