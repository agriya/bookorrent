    ...
    <table class="table table-striped table-bordered table-condensed">
      ...
      <?php if (!empty($inviteUsers)): ?>
        <?php foreach ($inviteUsers as $inviteUser): ?>
          <tr>
            <td class="dc"><?php echo $this->Form->input('SocialContact.' . $inviteUser['SocialContact']['id'] . '.id', array('type' => 'checkbox', 'id' => 'admin_checkbox_' . $inviteUser['SocialContact']['id'], 'label' => '', 'class' => 'js-checkbox-list','div' => 'input checkbox top-mspace')); ?></td>
