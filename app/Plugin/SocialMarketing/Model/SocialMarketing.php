...
class SocialMarketing extends AppModel
{
	...
	public function updateSocialActivityCount()
	{
        ...
        foreach($items as $item) {
            ...
            $_data['Item']['facebook_share_count'] = $this->getFacebookCount($url);
            $_data['Item']['twitter_share_count'] = $this->getTwitterCount($url);
            $_data['Item']['gmail_share_count'] = $this->getGmailCount($url);
            $_data['Item']['linkedin_share_count'] = $this->getLinkedinCount($url);
