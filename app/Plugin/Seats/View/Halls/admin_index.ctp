...
<div class="halls index">
	<ul class="breadcrumb top-mspace ver-space">
		...
		<li class="active"><?php echo __l('Halls');?></li>
	</ul> 
		...
		<tbody>
			...
			?>
					<tr class="<?php echo $class.' '.$active_class;?>">
						...
						<td class="dc"><?php 
							echo $this->Html->link($this->Html->cInt($hall['Hall']['partition_count'],false), array('controller'=> 'partitions', 'action'=>'index', 'slug' => $hall['Hall']['slug'], 'admin' => true), array('escape' => false,'title' => $this->Html->cInt($hall['Hall']['partition_count'],false)));?>
						</td>
