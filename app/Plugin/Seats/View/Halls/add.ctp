...
<?php } else {?>
	<h2 class="ver-space top-mspace text-32 sep-bot"><?php echo __l('Add Hall');?></h2>
<?php } ?>
<div class="halls form">
	...
	<fieldset>
		...
		?>
				<div class='clearfix'>
				<?php
				echo $this->Form->autocomplete('User.username', array('label'=> __l('Users'), 'acFieldKey' => 'Hall.user_id', 'acFields' => array('User.username'), 'acSearchFieldNames' => array('User.username'), 'maxlength' => '100', 'acMultiple' => false));
				?>
				</div>
		<?php 
			}
	...
	<div class="form-actions">
		<?php 
			echo $this->Form->submit(__l('Add'), array('class' => 'btn btn-large btn-primary textb text-16'));
		?>
	</div>
