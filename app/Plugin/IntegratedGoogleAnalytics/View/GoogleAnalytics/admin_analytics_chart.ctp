<div class="alert alert-info mspace"><?php echo sprintf(__l('This is integrated with Google Analytics. Update settings %s.'), $this->Html->link('here', array('controller'=> 'settings', 'action' => 'plugin_settings', 'IntegratedGoogleAnalytics'), array('class' => 'googleplusc'))); ?></div>
<?php
