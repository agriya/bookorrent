...
.maptimize_info_window .info {
	width:190px;
}
.bubbleMerchantAddress address{
	font-style:normal;
}
div.itemMapBubble div.bubbleDescription {
...
div.itemMapBubble div.bubbleLink {
	text-align:right;
}
div.itemMapBubble div.bubbleLink a {
	color:#EF540A;
}
.info {
	padding:0 0 0 2px;
...
<div class="maptimize_popup maptimize_info_window">
  <div>
    <div id="itemMapBubbleContainer">
      <div class="itemMapBubble">
	  <div class="img"><?php
	   echo $this->Html->link($this->Html->showImage('Item', $item['Attachment'][0], array('dimension' => 'medium_thumb', 'alt' => sprintf(__l('[Image: %s]'), $this->Html->cText($item['Item']['title'], false)), 'title' => $this->Html->cText($item['Item']['title'], false))), array('controller' => 'items', 'action' => 'view', $item['Item']['slug'],  'admin' => false), array('target'=>'_parent','title'=>$this->Html->cText($item['Item']['title'],false),'escape' => false));
					 ?></div>
	  <div class="info">
        <div class="bubbleMerchantName"> <?php echo $this->Html->link($this->Html->cText($item['Item']['title'], false), array('controller' => 'items', 'action' => 'view', $item['Item']['slug'], 'admin' => false), array('target'=>'_parent','title'=>$this->Html->cText($item['Item']['title'], false),'escape' => false)); ?></div>
        <div class="bubbleMerchantAddress">     <address class="address-info dc sfont">
        <span>
			<?php if(!empty($item['Country']['iso_alpha2'])): ?>
				...
				<?php endif; ?>
			<?php echo $this->Html->cText($item['Item']['address']) ?>
		</span>
    </address></div></div>
      </div>
    </div>
