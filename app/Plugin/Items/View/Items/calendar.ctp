...
if(!empty($type) && $type == 'guest'):?>
	<div class="js-calendar-response js-guestcalender-load-block">
		<?php
			echo $this->Calendar->month($year, $month, $id);
		?>
	</div>
<?php else: ?>
      ...
      <div id="calhead" style="padding-left:1px;padding-right:1px;">          
			...
			<h3 class="well space textb text-16"><?php echo __l('My Calendar');?></h3>
                <div  id="js-edit-month" class="fbutton">
	                <div class="price-button">
                    	<input type="button" id="js-edit-month-price" value="<?php echo __l('Edit Monthly Price');?>"/> 
                    </div>
            ...
            <div  id="showmonthbtn" class="fbutton fcurrent">
              ...
              <div  id="showreflashbtn" class="fbutton">
                <div><span title="<?php echo __l('Refresh view'); ?>" class="showdayflash"><?php echo __l('Refresh');?></span></div>
                </div>
             <div class="btnseparator"></div>
                <div id="sfprevbtn" title="<?php echo __l('Prev'); ?>"  class="fbutton">
                  <span class="fprev"></span>

                </div>
                <div id="sfnextbtn" title="<?php echo __l('Next'); ?>" class="fbutton">
