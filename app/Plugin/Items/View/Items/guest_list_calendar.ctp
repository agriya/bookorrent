...
$prev_url = Router::url(array(
            ...
            'item_id' => $guest_lists[0]['id'],
        ) , true);
        echo "<span class='text-24 textb prev {\"url\":\"$prev_url\"} js-guest-calender-prev ui-datepicker-prev ui-corner-all'> <i class=' icon-chevron-left'></i> </span>";
?>
</div>
...
<?php 
        ...
        echo " <span class='text-24 textb next {\"url\":\"$next_url\"} js-guest-calender-next ui-datepicker-next ui-corner-all'> <i class=' icon-chevron-right'></i> </span>";
		else:
		$next_url='';
		endif;
?>
