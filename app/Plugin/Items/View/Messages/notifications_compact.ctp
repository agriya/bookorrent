  <ol class="unstyled left-space <?php echo !empty($messages)?'activities-list':''?> ">
	<?php		
	 $span_size = 'span8';
	  if (!empty($messages)):
	...
	?>
		<?php if(!empty($message['Message']['item_user_status_id'])):?>
			...
			<?php if(!empty($message['Message']['item_user_status_id']) && $message['Message']['item_user_status_id'] != ConstItemUserStatus::SenderNotification && $message['Message']['item_user_status_id'] != ConstItemUserStatus::BookerReviewed && $message['Message']['item_user_status_id'] != ConstItemUserStatus::HostReviewed && $message['Message']['item_user_status_id'] != ConstItemUserStatus::BookerConversation && $message['Message']['item_user_status_id'] != ConstItemUserStatus::PrivateConversation && $message['Message']['item_user_status_id'] != ConstItemUserStatus::BookingRequestConfirmed && $message['Message']['item_user_status_id'] != ConstItemUserStatus::BookingRequestConversation):?>				
				...
				<li class=" no-mar bot-space <?php echo $message['ItemUserStatus']['slug'];?> activity-status clearfix <?php echo $user_type_container_class;?>">
					<div class="row no-mar"> 
						...
						<div class="thumbnail activity-content-compact mob-no-mar mob-ps clearfix no-round">
							...
							<p class="<?php echo $span_size;?> grayc clearfix no-mar"><?php echo $this->Html->conversationDescription($message, 'orangec no-mar no-pad');?> </p>
						</div>
					</div>				
				</li>
				<?php endif;?>
			...
			<?php if($message['Message']['item_user_status_id'] == ConstItemUserStatus::BookingRequestConversation):?>				
				...
				<li class=" no-mar bot-space <?php echo $user_type_container_class;?>">
			  ...
			  <div class="row no-mar"> 
				...
				<div class="thumbnail activity-content-compact mob-no-mar mob-ps clearfix no-round">
				  ...
				  <p class="<?php echo $span_size;?> grayc clearfix no-mar">
...
<?php if (!empty($messages)): ?>
	<section>
		<div class="pull-left">
			<?php echo $this->Html->link(__l('See all activities'), array('controller' => 'messages', 'action' => 'notifications', 'type' => 'list', 'admin' => false), array('class' => 'linkc','escape' => false));?>
		</div>
		<div class="pull-right hor-space">
			<?php echo $this->Html->link(__l('Clear activities'), array('controller' => 'messages', 'action' => 'clear_activities', 'admin' => false, 'final_id' => $final_id['Message']['id']), array('class' => 'no-mar js-no-pjax btn','escape' => false));?>
		</div>
    </section>
<?php endif; ?>