...
<div class="page-information">
			...
			<?php  endif;
				...
				echo $this->Form->input('type', array('type' => 'hidden'));
					...
					if((!empty($this->request->params['named']['review']) && ($this->request->params['named']['review'] == '1')) || (!empty($this->request->data['Message']['item_is_from_review']) || (!empty($this->request->data['Message']['is_review'])))):
						echo $this->Form->input('item_is_from_review', array('type' => 'hidden', 'value' =>  1));
					endif;
