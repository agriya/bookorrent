<div id="activities" class="js-response clearfix">
	...
	?>
				<div class="clearfix bot-mspace">
					...
					<span class="js-timestamp pull-left left-smspace" title="<?php echo $this->Html->cDateTime($time_format, false);?>"><?php echo $this->Html->cDateTimeHighlight($message['Message']['created'], false); ?></span>				
				</div>   
	<?php
			endforeach;
		else: ?>
