...
?>
    <tr>
		<td class="space span3 textb grayc ">
				<span>
				...
				<span class="user-name-block pull-right span2 htruncate js-bootstrap-tooltip" title="<?php echo $this->Html->cText($message['OtherUser']['username'], false);?>">
                    <?php
        ...
        <td  class=" grayc span17 <?php echo $row_three_class;?> <?php  echo $is_read_class;?>">
			<?php 
...
<tr>
    <td colspan="4">
	  <div class="space dc grayc">
		<p class="ver-mspace top-space text-16 "><?php echo __l('No Messages available') ?></p>
	  </div>
	</td>
</tr>
<?php
