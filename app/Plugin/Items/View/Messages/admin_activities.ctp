<div id="activities" class="js-response clearfix">
	<ul class="breadcrumb top-mspace ver-space">
	  ...
	  <li class="active"><?php echo Configure::read('item.alt_name_for_item_singular_caps') . ' ' . __l('Activities'); ?></li>
	</ul>
		...
		<div class="ver-space">
			...
			?>
						<div class="clearfix bot-mspace">
							...
							<span class="js-timestamp pull-left left-smspace" title="<?php echo $time_format;?>"><?php echo $this->Html->cDateTimeHighlight($message['Message']['created'], false); ?></span>				
						</div>    
			<?php
					endforeach;
				else: ?>
