...
?>
<ol class="unstyled prop-list prop-list-mob no-mar js-view-count-update {'model':'request','url':'<?php echo $this->Html->cText($view_count_url, false); ?>'}">
<?php 
		$divsize = "span21";
...
?>
	<li class="clearfix ver-space sep-bot hor-smspace">
			<?php $date = explode('-', $request['Request']['from']); ?>
								...
								<div class=" clearfix <?php echo (isset($is_favorite))? '':'sep-bot' ?>">
									...
									<?php endif; ?>
										<div class="clearfix pull-left hor-space left-mspace sep-left mob-sep-none tab-no-mar mob-clr mob-dc">
											<p class="no-mar"><?php echo $this->Html->cDate($request['Request']['from']); ?><?php echo ' - '; ?><?php echo $this->Html->cDate(getToDate($request['Request']['to'])); ?></p>
