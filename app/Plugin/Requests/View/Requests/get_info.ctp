...
div.requestMapBubble div.bubbleDescription {
...
div.requestMapBubble div.bubbleLink {
	text-align:right;
}
div.requestMapBubble div.bubbleLink a {
	color:#EF540A;
}
.info
{
...
<div class="maptimize_popup maptimize_info_window">
  <div>
    <div id="requestMapBubbleContainer">
      <div class="requestMapBubble">
	  <div class="info">
        <div class="bubbleMerchantName"> <?php echo $this->Html->link($this->Html->cText($request['Request']['title'], false), array('controller' => 'requests', 'action' => 'view', $request['Request']['slug'], 'admin' => false), array('target'=>'_parent','title'=>$this->Html->cText($request['Request']['title'], false),'escape' => false)); ?></div>
        <div class="bubbleMerchantAddress"><address class="address-info sfont dl clearfix">
        <span>
