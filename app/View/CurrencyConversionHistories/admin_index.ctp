 ...
 <div class="ver-space">
	...
	<tr class=" well no-mar no-pad">
		<th class="actions sep-right span2"><?php echo __l('Actions');?></th>
			...
			<th class="graydarkc sep-right dc"><?php echo $this->Paginator->sort('currency_id',__l('Currency'));?></th>
			<th class="graydarkc sep-right dc"><?php echo $this->Paginator->sort('converted_currency',__l('Converted Currency'));?></th>
			<th class="graydarkc sep-right dc"><?php echo $this->Paginator->sort('rate_before_change',__l('Rate Before Change'));?></th>
			<th class="graydarkc sep-right dc"><?php echo $this->Paginator->sort('rate',__l('Rate'));?></th>
		</tr></thead><tbody>
	<?php
if (!empty($currencyConversionHistories)):
	...
	?>
	<tr<?php echo $class;?>>
	   <td class="dc"><span class="dropdown dc"> <span title="<?php echo __l('Actions');?>" data-toggle="dropdown" class="graydarkc left-space hor-smspace icon-cog text-18 cur dropdown-toggle"> <span class="hide"><?php echo __l('Actions');?></span> </span>
