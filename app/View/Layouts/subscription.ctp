    ...
    <div id="<?php echo $this->Html->getUniquePageId();?>" class="content js-responses">
      ...
      <div class="beta-block">
        <section class="thumbnail dc space thumb-alpha">
          ...
          <?php
            ...
            $item_url = Router::url('/', true);
            $item_title = Configure::read('site.name');
      ...
      <footer id="footer" class="top-mspace space clearfix">
        <div id="agriya" class="container clearfix">
          <p class="span">&copy;<?php echo date('Y');?> <?php echo $this->Html->link(Configure::read('site.name'), Router::Url('/',true), array('title' => Configure::read('site.name'), 'class' => 'site-name textb',  'escape' => false)) .  '. ' . __l('All rights reserved') . '.';?></p>
          <p class="powered clearfix span"><span  class="pull-left"><a href="http://bookorrent.dev.agriya.com" title="<?php echo __l('Powered by BookorRent'); ?>" target="_blank" class="powered pull-left"><?php echo __l('Powered by BookorRent'); ?></a> <span class="made-in pull-left">,<?php echo  'made in';?></span> <a class="company pull-left" title="<?php echo __l('Agriya Web Development'); ?>" target="_blank" href="http://www.agriya.com/"><?php echo __l('Agriya Web Development'); ?></a> <span class="pull-left"><?php echo Configure::read('site.version');?></span></p>
          <p id="cssilize" class="span"><a href="http://www.cssilize.com/" title="<?php echo __l('CSSilized by CSSilize, PSD to XHTML Conversion'); ?>" target="_blank"><?php echo __l('CSSilized by CSSilize, PSD to XHTML Conversion'); ?></a></p>
        </div>
      </footer>
    </div>
  </body>
