<?php /* SVN: $Id: admin_index.ctp 74194 2011-12-15 13:33:05Z meganathan_203ac11 $ */ ?>
	...
	<ul class="breadcrumb top-mspace ver-space">
              ...
              <li class="active"><?php echo __l('Languages');?>  </li>
            </ul> 
	...
	<tr class=" well no-mar no-pad">
		<th class="dl span2"><?php echo __l('Select'); ?></th>
            ...
            <th class="dc sep-right"><div class="js-pagination"><?php echo $this->Paginator->sort( 'Language.iso2',__l('ISO2'));?></div></th>
            <th class="dc sep-right"><div class="js-pagination"><?php echo $this->Paginator->sort( 'Language.iso3',__l('ISO3'));?></div></th>
			</tr></thead><tbody>
         <?php
            if (!empty($languages)):
                $i = 0;
