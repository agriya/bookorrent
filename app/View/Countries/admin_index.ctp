...
<ul class="breadcrumb top-mspace ver-space">
              ...
              <li class="active"><?php echo __l('Countries'); ?></li>
            </ul> 
     ...
     <table class="table no-round table-striped">
      <thead>
        <tr>
          ...
          <th rowspan="2" class="dl"><div><?php echo $this->Paginator->sort('fips_code', __l('Fips Code'));?></div></th>
          <th rowspan="2" class="dl"><div><?php echo $this->Paginator->sort('iso_alpha2',__l('Iso Alpha2'));?></div></th>
          <th rowspan="2" class="dl"><div><?php echo $this->Paginator->sort('iso_alpha3',__l('Iso Alpha3'));?></div></th>
          <th rowspan="2" class="dc"><div><?php echo $this->Paginator->sort('iso_numeric',__l('Iso Numeric'));?></div></th>
          <th rowspan="2" class="dl"><div><?php echo $this->Paginator->sort('capital',__l('Capital'));?></div></th>
