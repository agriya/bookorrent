...
<ul class="breadcrumb top-mspace ver-space">
              ...
              <li class="active"><?php echo __l('States'); ?></li>
            </ul> 
	...
	<tr class=" well no-mar no-pad">
            ...
            <?php
                ...
                $i = 0;
        			...
        			<li><?php echo $this->Html->link('<i class="icon-thumbs-down"></i>'.__l('Disable'), array('action' => 'update_status', $state['State']['id'], 'status' => 'disapproved'), array('escape' => false,'class' => 'edit', 'title' => __l('Disable')));?></li>
					<?php else: ?>
					<li><?php echo $this->Html->link('<i class="icon-thumbs-up"></i>'.__l('Enable'), array('action' => 'update_status', $state['State']['id'], 'status' => 'approved'), array('escape' => false,'class' => 'delete js-delete', 'title' => __l('Enable')));?></li>
						<?php endif; ?>
