...
<div class="span6 tab-clr top-mspace right-space sep-right">
  ...
  <dl class="top-mspace sep-bot clearfix">
	<dt class="bot-space span textn no-mar"><?php echo Configure::read('item.alt_name_for_item_plural_caps') . ' ' . __l('posted'); ?></dt>
	<dd class="bot-space span graydarkc textb"><?php echo $this->Html->cInt($user['User']['item_count']);?></dd>
  </dl>
  <div class="top-space clearfix">
	...
	<dl class="dc sep-right list">
	  ...
	  <dd class="textb text-20 no-mar graydarkc pr hor-mspace"><?php echo numbers_to_higher($user['User']['item_feedback_count'] - $user['User']['positive_feedback_count']); ?></dd>
	</dl>
	<dl class="dc  list">
...
<div class="span6 tab-clr top-mspace left-space">
  <h3 class="textb top-space top-mspace text-24"><?php echo __l('As') . ' ' . Configure::read('item.alt_name_for_booker_singular_caps'); ?></h3>
  ...
  <div class="top-space clearfix">
	<dl class="dc list">
	  <dt class="pr hor-mspace text-11"><?php echo __l('Positive');?></dt>
	  <dd class="textb text-20 no-mar graydarkc pr hor-mspace"><?php echo numbers_to_higher($user['User']['booker_positive_feedback_count']); ?></dd>
	</dl>
	<dl class="dc sep-right list">
	  <dt class="pr hor-mspace text-11"><?php echo __l('Negative');?></dt>
	  <dd class="textb text-20 no-mar graydarkc pr hor-mspace" ><?php echo numbers_to_higher($user['User']['booker_item_user_count'] - $user['User']['booker_positive_feedback_count']); ?></dd>
	</dl>
	<dl class="dc  list">
	  <dt class="pr hor-smspace text-11"><?php echo __l('Success Rate'); ?></dt>
	  <?php if(($user['User']['booker_item_user_count']) == 0): ?>
		<dd class="textb text-20 no-mar graydarkc pr hor-mspace" title="<?php echo __l('n/a');?>"><?php echo __l('n/a');?></dd>
	   <?php else: ?>
	   <dd class="textb text-20 no-mar graydarkc pr hor-mspace"><span class="stats-val">
