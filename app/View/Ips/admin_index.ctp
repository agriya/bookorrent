...
<div class="ver-space">
	...
	<tr class=" well no-mar no-pad">
        ...
        <th class="dl sep-right"><?php echo $this->Paginator->sort('city_id',__l('City'));?></th>
        <th class="dl sep-right"><?php echo $this->Paginator->sort('state_id',__l('State'));?></th>
        <th class="dl sep-right"><?php echo $this->Paginator->sort('country_id',__l('Country'));?></th>
        <th class="sep-right"><?php echo $this->Paginator->sort('latitude',__l('Latitude'));?></th>
        <th class="sep-right"><?php echo $this->Paginator->sort('longitude',__l('Longitude'));?></th>
    </tr></thead><tbody>
<?php
if (!empty($ips)):
