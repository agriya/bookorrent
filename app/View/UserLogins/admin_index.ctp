...
<ul class="breadcrumb top-mspace ver-space">
              ...
              <li class="active"><?php echo __l('User Logins'); ?></li>
            </ul> 
...
<div class="clearfix dc">
 ...
 <div class="ver-space">
	...
	<tr class=" well no-mar no-pad js-even">
            ...
            <th class="dl graydarkc sep-right"><div class="js-pagination"><?php echo $this->Paginator->sort('ip_id',__l('User Login IP'));?></div></th>
        ...
        if (!empty($userLogins)):
            ...
            foreach ($userLogins as $userLogin):
                ...
                ?>
                <tr <?php echo $class;?>>
                    <td class="dc"><?php echo $this->Form->input('UserLogin.'.$userLogin['UserLogin']['id'].'.id', array('type' => 'checkbox', 'id' => "admin_checkbox_".$userLogin['UserLogin']['id'], 'label' => "", 'class' => 'js-checkbox-list')); ?></td>
                    ...
                    <td class="dl"><?php echo $this->Html->link($this->Html->cText($userLogin['User']['username']), array('controller'=> 'users', 'action'=>'view', $userLogin['User']['username'], 'admin' => false), array('escape' => false));?></td>
                   	<td class="dl">
                        <?php if(!empty($userLogin['Ip']['ip'])): ?>
                            <?php echo  $this->Html->link($userLogin['Ip']['ip'], array('controller' => 'users', 'action' => 'whois', $userLogin['Ip']['ip'], 'admin' => false), array('class' => 'js-no-pjax', 'target' => '_blank', 'title' => __l('whois').' '.$userLogin['Ip']['host'], 'escape' => false));
							?>
							<p>
							<?php
