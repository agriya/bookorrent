    ...
    <div class="tabbable span9">
      <div id="list" class="tab-pane active in no-mar">
		  ...
		  <div class="pull-left">	
    		...
    		echo $this->Form->input('ItemUser.Id', array('label' => false,'div'=>'span4 right-mspace','placeholder'=> __l('Booking#'), 'class'=>'span4'));
    		echo $this->Form->autocomplete('Item.title', array('label' => false,'div'=>'span right-mspace','class'=>'span4','placeholder' => Configure::read('item.alt_name_for_item_singular_caps'), 'acFieldKey' => 'Item.id', 'acFields' => array('Item.title'), 'acSearchFieldNames' => array('Item.title'), 'maxlength' => '255')); ?>
			<div class="date-time-block pull-left">
			  <div class="input date-time">
				<div class="js-datetime">
				  <div class="js-cake-date">
					<?php echo $this->Form->input('from_date', array('orderYear' => 'asc', 'type' => 'date', 'label' => __l('From'), 'minYear' => date('Y')-5, 'maxYear' => date('Y') + 10, 'div' => false, 'empty' => __l('Please Select'))); ?>
				  </div>
				</div>
			  </div>
			  <div class="input date-time today-date-block">
				<div class="js-datetime">
				  <div class="js-cake-date">
					<?php echo $this->Form->input('to_date', array('orderYear' => 'asc', 'type' => 'date', 'label' => __l('To'), 'minYear' => date('Y')-5, 'maxYear' => date('Y') + 10, 'div' => false, 'empty' => __l('Please Select'))); ?>
				  </div>
				</div>
			  </div>
			</div>
			<?php echo $this->Form->input('filter_id', array('type' => 'hidden'));
			echo $this->Form->submit(__l('Filter'),array('class'=>'btn btn-large top-space hor-mspace btn-primary textb text-16')); ?>
        ...
        <tr<?php echo $class;?>>
                ...
                <?php
					$current_user_details = array(
						...
						'facebook_user_id' => $transaction['User']['facebook_user_id']
					);
