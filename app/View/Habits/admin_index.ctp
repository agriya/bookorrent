<?php /* SVN: $Id: $ */ ?>
<div class="habits index js-response">
<ul class="breadcrumb top-mspace ver-space">
              ...
              <li class="active"><?php echo __l('Habits');?></li>
            </ul> 
...
<?php   
	echo $this->Form->create('Habit' , array('class' => 'normal','action' => 'update'));
...
?>
	<tr class="<?php echo $class . $active_class;?>">
		<td class="dc"><?php echo $this->Form->input('Habit.'.$habit['Habit']['id'].'.id', array('type' => 'checkbox', 'id' => "admin_checkbox_".$habit['Habit']['id'], 'label' => "", 'class' => ' js-checkbox-list')); ?></td>
		<td class="dc"><span class="dropdown"> <span title="<?php echo __l('Actions');?>" data-toggle="dropdown" class="graydarkc left-space hor-smspace icon-cog text-18 cur dropdown-toggle"> <span class="hide"><?php echo __l('Actions');?></span> </span>
					...
					<li><?php echo $this->Html->link('<i class="icon-edit"></i>'.__l('Edit'), array('action' => 'edit', $habit['Habit']['id']), array('escape' => false,'class' => 'delete', 'title' => __l('Edit')));?></li>
        			<li><?php echo $this->Html->link('<i class="icon-remove"></i>'.__l('Delete'), array('action' => 'delete', $habit['Habit']['id']), array('escape' => false,'class' => 'delete js-delete', 'title' => __l('Delete')));?></li>
			   </ul>
							 </span>
                            </td>
		<td class="dc"><?php echo $this->Html->cDateTime($habit['Habit']['created']);?></td>
		<td class="dl"><?php echo $this->Html->cText($habit['Habit']['name']);?></td>
	</tr>
<?php
    endforeach;
else:
?>
	<tr>
		<td colspan="7"><div class="space dc grayc"><p class="ver-mspace top-space text-16 "><?php echo sprintf(__l('No %s Types available'), Configure::read('item.alt_name_for_item_singular_caps'));?></p></div></td>
	</tr>
<?php
endif;
?>
