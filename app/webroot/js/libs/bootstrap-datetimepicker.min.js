...
(function ($) {
	...
	DateTimePicker.prototype = {
		...
		init : function (element, options) {
			...
			if (this.$element.is(".input-append") || this.$element.is(".input-prepend"))
				this.component = this.$element.find(".add-onn");
		...
		show : function (e) {
			...
			if ('ontouchstart' in document.documentElement) {
			  ...
			  $('<div class="datepicker-backdrop"/>').insertBefore(this.widget).on('click', $.proxy(this.hide, this));
			}
			...
			if (!dateStr) {
				if (this.isInput) {
					...
					if(this.$element.data("date")){
						dateStr = this.$element.data("date");
					}else{
		...
		showMode : function (dir) {
			...
			this.widget.find(".datepicker2 > div").hide().filter(".datepicker-" + DPGlobal.modes[this.viewMode].clsName).show()
		},
		destroy : function () {
			this._detachDatePickerEvents();
			this._detachDatePickerGlobalEvents();
		...
		_attachDatePickerEvents : function () {
			var self = this;
			this.widget.on("click", ".datepicker2 *", $.proxy(this.click, this));
			...
			if (this.pickDate && this.pickTime) {
				this.widget.on("click.togglePicker", ".accordion-toggle", function (e) {
					...
					if (expanded && expanded.length) {
						...
						self.$element.find(".add-onn i").toggleClass(self.timeIcon + " " + self.dateIcon)
					}
				})
			}
			if (this.isInput) {
		...
		_detachDatePickerEvents : function () {
			this.widget.off("click", ".datepicker2 *", this.click);
	...
	function getTemplate(timeIcon, pickDate, pickTime, is12Hours, showSeconds) {
		if (pickDate && pickTime) {
			...
			return '<div class="bootstrap-datetimepicker-widget dropdown-menu">' + '<div class="datepicker2">' + DPGlobal.template + "</div>" + "</div>"
		}
	}
	function UTCDate() {
