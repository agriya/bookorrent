...
$(document).ready(function(){
    ...
    (function( bootstro, $, undefined ) {
        ...
        var defaults = {
            nextButton : '<button class="btn btn-primary btn-mini bootstro-next-btn">' + __l('Next') +' &raquo;</button>',
            prevButton : '<button class="btn btn-primary btn-mini bootstro-prev-btn">&laquo; ' + __l('Prev') +'</button>',
            finishButton : '<button class="btn btn-mini btn-success bootstro-finish-btn"><i class="icon-ok"></i> ' + __l('Close') +'</button>',
